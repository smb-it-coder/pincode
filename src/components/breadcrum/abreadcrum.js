...
function Abreadcrum() {
  ...
  const district =  ((params.area).replaceAll(/-pincode/ig, "")).replaceAll(/-/ig, " ");
    ...
    <div className="container-fluid bg-info mb-5" >
      <div className="d-flex flex-column align-items-center justify-content-center" style={{'min-height': 100 + 'px'}} >
        ...
        <div className="d-inline-flex text-white">
          ...
          <p className="m-0"><a class="text-white" href={`/state/${state.replaceAll(/ /ig, "-")}-Pincode`}>{state}</a></p>
          <p className="m-0 px-2">/</p>
